...
def plotvoronoiOutput( data_points, vor , CellRad, nRuns ,     outfilename , OPATH_fig , method , nb  , w , h , OffsetAU , data_type , inputimg  ):
...
def plotvoronoiOverlay( data_points,  CellRad , nRuns ,  outfilename , OPATH_fig ,  nb  , w , h , OffsetAU , data_type , inputimg   ):
...
def plotvoronoiOverlayRaw( data_points,  CellRad , nRuns ,  inner_bp , outfilename , OPATH_fig ,  w , h , OffsetAU ,  inputimg   ):
